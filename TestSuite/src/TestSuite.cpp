...
TestClass::TestClass(std::string Class, std::string Function)
{
	ClassName = Class;
...
std::string TestClass::getClass()
{
	return ClassName;
}
std::string TestClass::getFunction()
{
	return FunctionName;
}
...
void TestSuite::give(TestClass* instance)
{
